        ...
        <footer className="bg-gray-900 text-white p-10 mt-10">
            <div className='flex flex-col sm:justify-between sm:flex-row gap-10 md:gap-50 mb-6'>
                <div className="">
                    ...
                    <p className="text-gray-400">Your only need for managing tasks</p>
                </div>
            ...
            <span className="text-gray-400 text-md hover:text-white">© 2026 Task Tracker. All rights reserved.</span>
        </footer>
    )
}
